...
import Photo from "../images/Rectangle 12.png";
import DrinkPhoto from "../images/Rectangle 5.png";
          ...
          <Row>
            ...
            <Col>
              <Row>
                ...
                <p className="fullname-text">Egi Ganteng</p>
              </Row>
              <Row>
                <p className="fullname-title">Email</p>
                <p className="fullname-text">egigans@gmail.com</p>
              </Row>
            </Col>
          </Row>
        </Col>
